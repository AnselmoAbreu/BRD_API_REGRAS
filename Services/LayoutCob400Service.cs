...
namespace BRD_API_REGRAS.Services
{
    public class LayoutCob400Service
    {
        ...
        const string registroZero = "REGISTRO_HEADER_ARQUIVO_(0)"; // Header de arquivo
        const string registroNove = "REGISTRO_TRAILER_ARQUIVO_(9)"; // Trailer de arquivo
        ...
        public dynamic MontarJsonCob400(dynamic dynamicList, string codigoArquivo) // COB400
        {
            ...
            cdObject7 = new
            {
                TipoRegistro = "001:001:N:R:0:001-001::Erro - Tipo Registro:",
